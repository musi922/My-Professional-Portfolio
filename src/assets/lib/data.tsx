...
import profilepicture from "../../assets/portImage.jpg";
...
export const headerIntroData = {
  title: {
    de: "Hi, ich bin Richard Musime",
    en: "Hi, I'm Richard Musime",
  },
  subtitle: "Fullstack Developer ",
  description: {
    de: "Ich bin Richard, ein Fullstack-Entwickler mit dem Ziel, meine Karriere voranzutreiben und an inspirierenden Projekten teilzunehmen. Hier präsentiere ich meine Arbeiten und meine Leidenschaft für die Webentwicklung. Lassen Sie uns gemeinsam digitale Lösungen gestalten und die Zukunft formen!",
    en: "I'm Richard, a fullstack developer with the goal of advancing my career and participating in inspiring projects. Here I present my work and my passion for web development. Let's shape digital solutions together and shape the future!",
  },
  buttons: [
    {
      name: "Contact",
...
export const projectsData = [
  {
    ...
    githuburl: "https://github.com/musi922",
    githubicon: FiGithub,
...
export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/richard-musime-2b9359267/",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
...
export const contactData = {
  ...
  privacyOptIn: {
    checkbox: {
      de: "Ich stimme zu, dass Richard meine personenbezogenen Daten (Name und E-Mail-Adresse) verwenden darf, um mit mir Kontakt aufzunehmen.",
      en: "I agree that Richard may use my personal data (name and e-mail address) to contact me.",
    },
    description: {
